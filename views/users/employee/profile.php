<div class='container-fluid' ng-controller='empProf'>
  <div class='row'>
    ...
    <div class='col-md-6'>
      ...
      <div class='content-container'>
        ...
        <div ng-show='showInfo'>
          <ng-include src="'/views/users/employee/prof_settings/info_setting.php'"></ng-include>
        </div>
      </div>
      <div class='content-container'>
        ...
        <div ng-show='showAcct'>
          <ng-include src="'/views/users/employee/prof_settings/acct_setting.php'"></ng-include>
        </div>
      </div>
      <div class='content-container'>
        ...
        <div ng-show='showPic'>
          <ng-include src="'/views/users/employee/prof_settings/pic_setting.php'"></ng-include>
        </div>
      </div>
    </div>
  </div>
